...
- [ ] 创建 Tauri 项目结构
- [ ] 配置 Rust 后端环境
- [ ] 配置 Vue 3 + TypeScript 前端环境
- [ ] 配置 TailwindCSS
- [ ] 设置项目目录结构

#### 1.2 核心数据结构设计
- [ ] 设计插件数据模型（Plugin Source, Plugin Package, Plugin Unit）
- [ ] 设计项目数据模型
- [ ] 设计配置数据模型
- [ ] 实现本地 JSON 存储模块
...
#### 1.4 项目扫描功能（原型）
- [ ] 实现递归扫描 project.godot 文件
- [ ] 解析 project.godot 文件内容
- [ ] 展示项目列表（基础 UI）
...
#### 5.1 主界面布局
- [ ] 实现三栏布局（项目列表 | 插件选择 | 变更预览）
- [ ] 实现全局总览面板
- [ ] 实现状态标签系统（Ready/In Use/Conflict/Warning/Missing Source）
- [ ] 实现未应用变更提示
