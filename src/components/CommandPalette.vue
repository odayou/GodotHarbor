...
<template>
  <Teleport to="body">
    ...
    >
      <div
        class="w-full max-w-lg bg-white dark:bg-surface-card rounded-island shadow-2xl border border-gray-200/60 dark:border-surface-border/40 overflow-hidden"
        @keydown="onKeyDown"
      >
        <div class="flex items-center px-4 border-b border-gray-200/60 dark:border-surface-border/40">
          ...
          />
          <kbd class="hidden sm:inline-flex items-center px-2 py-0.5 text-xs text-gray-400 dark:text-content-muted bg-gray-100 dark:bg-surface-hover rounded-[4px] border border-gray-200/60 dark:border-surface-border/40 shrink-0">
            Esc
          </kbd>
        </div>
              ...
              >
                <div class="w-7 h-7 rounded flex items-center justify-center shrink-0"
                  :class="getFlatIndex(item) === selectedIndex
                    ? 'bg-primary-100 dark:bg-surface-hover'
                ...
                >
                  ...
                  <svg v-else-if="item.icon === 'import'" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="butt" stroke-linejoin="miter" stroke-width="1.5" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                  </svg>
                  <svg v-else-if="item.icon === 'language'" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="butt" stroke-linejoin="miter" stroke-width="1.5" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" />
                  </svg>
                ...
                <kbd v-if="item.shortcutKey && !query.trim()"
                  class="px-1.5 py-0.5 text-[11px] font-mono text-gray-400 dark:text-content-muted bg-gray-100 dark:bg-surface-hover rounded-[4px] border border-gray-200/60 dark:border-surface-border/40 shrink-0 min-w-[20px] text-center"
        ...
        <div class="px-4 py-2 border-t border-gray-200/60 dark:border-surface-border/40 flex items-center gap-4 text-xs text-gray-400 dark:text-content-muted">
          <span class="flex items-center gap-1">
            <kbd class="px-1 py-0.5 bg-gray-100 dark:bg-surface-hover rounded-[4px] border border-gray-200/60 dark:border-surface-border/40 text-[10px]">↑↓</kbd>
          ...
          <span class="flex items-center gap-1">
            <kbd class="px-1 py-0.5 bg-gray-100 dark:bg-surface-hover rounded-[4px] border border-gray-200/60 dark:border-surface-border/40 text-[10px]">1-9</kbd>
            {{ t('commandPalette.quickSelect') }}
          </span>
          <span class="flex items-center gap-1">
            <kbd class="px-1 py-0.5 bg-gray-100 dark:bg-surface-hover rounded-[4px] border border-gray-200/60 dark:border-surface-border/40 text-[10px]">Esc</kbd>
      ...
      <div class="dialog-container w-full max-w-md max-h-[80vh] flex flex-col" @click.stop>
        ...
        <div v-else-if="matchedEngines.length === 0" class="flex-1 py-8 text-center">
          ...
          <button
            ...
            class="mt-3 px-3 py-1.5 text-xs font-medium btn-primary transition-colors"
          >
