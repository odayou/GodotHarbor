...
<template>
  <div class="h-full flex flex-col">
    <div class="px-3 pb-3">
      <h1 class="text-sm font-semibold text-gray-900 dark:text-content-primary">{{ t('build.title') }}</h1>
      <p class="text-xs text-gray-500 dark:text-content-muted mt-0.5">{{ t('build.subtitle') }}</p>
    </div>

    <div class="px-3 flex gap-1 border-b border-gray-200/60 dark:border-surface-border/40 mb-3">
      <button
        v-for="tab in ([
    ...
    <div class="flex-1 overflow-y-auto px-3 pb-3">
      ...
      <div v-if="activeTab === 'export'">
        ...
        <div v-else class="grid gap-3">
          <div
            ...
            class="flex items-center justify-between p-3 bg-white dark:bg-surface-card rounded border border-gray-200/60 dark:border-surface-border/40"
          >
            ...
            <div class="flex items-center gap-2">
              <button
                v-if="!tmpl.installed"
                class="px-3 py-1.5 text-sm font-medium btn-primary transition-colors disabled:opacity-50"
              ...
              <button
                v-if="!tmpl.installed"
                class="px-3 py-1.5 text-sm font-medium text-primary-600 dark:text-brand-primary hover:bg-primary-50 dark:hover:bg-surface-hover rounded transition-colors disabled:opacity-50"
              ...
              <button
                v-if="tmpl.installed"
                class="px-3 py-1.5 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20 rounded transition-colors"
        ...
        <div v-if="downloadProgress" class="bg-primary-50 dark:bg-surface-hover border border-primary-200 dark:border-surface-border rounded p-3 mt-3">
          <div class="flex items-center gap-3">
            ...
            <svg v-else class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="butt" stroke-linejoin="miter" stroke-width="1.5" d="M5 13l4 4L19 7" /></svg>
      ...
      <div class="mt-6 pt-4 border-t border-gray-200/60 dark:border-surface-border/40">
        <h3 class="text-sm font-semibold text-gray-900 dark:text-content-primary mb-3">{{ t('build.presets') }}</h3>
        ...
        <div class="grid gap-3 sm:grid-cols-2">
          <div
            ...
            class="p-3 bg-white dark:bg-surface-card rounded border border-gray-200/60 dark:border-surface-border/40"
          >
            ...
            <div class="flex items-center gap-2">
              <button
                class="px-3 py-1.5 text-sm font-medium text-primary-600 hover:text-primary-700 bg-primary-50 hover:bg-primary-100 dark:bg-surface-hover dark:text-brand-primary dark:hover:bg-surface-hover rounded transition-colors"
                @click="applyPreset(preset)"
              >
                {{ t('build.applyPreset') }}
              </button>
              <button
                class="px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-gray-700 bg-gray-50 hover:bg-gray-100 dark:bg-surface-layer dark:text-content-secondary dark:hover:bg-surface-border rounded transition-colors"
        ...
        <div class="mt-4 p-3 bg-white dark:bg-surface-card rounded border border-gray-200/60 dark:border-surface-border/40">
          ...
          <div class="flex gap-2">
            <input
              ...
              class="flex-1 px-3 py-2 text-sm bg-white dark:bg-surface-layer border border-gray-300 dark:border-surface-border rounded text-gray-900 dark:text-content-primary focus:ring-1 focus:ring-primary-500 outline-none"
            />
            <button
      ...
      <div v-if="activeTab === 'build'">
        ...
        <div class="bg-white dark:bg-surface-card rounded border border-gray-200/60 dark:border-surface-border/40 p-4 mb-4">
          <div class="grid gap-3 sm:grid-cols-3">
            ...
            <div>
              ...
              <select
                ...
                class="w-full max-w-xs select-field"
              >
            ...
            <div class="flex items-end gap-2">
              <button
                class="flex-1 px-3 py-2 text-sm font-medium btn-primary transition-colors disabled:opacity-50"
        ...
        <div v-if="buildProgress" class="bg-primary-50 dark:bg-surface-hover border border-primary-200 dark:border-surface-border rounded p-3 mb-4">
          <div class="flex items-center gap-3">
            ...
            <svg v-else-if="buildProgress.stage === 'complete'" class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="butt" stroke-linejoin="miter" stroke-width="1.5" d="M5 13l4 4L19 7" /></svg>
            <svg v-else class="w-5 h-5 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="butt" stroke-linejoin="miter" stroke-width="1.5" d="M6 18L18 6M6 6l12 12" /></svg>
            <div class="flex-1 min-w-0">
              <div class="flex items-center justify-between">
      ...
      <!-- CI/CD Section -->
      <div class="mt-6 pt-4 border-t border-gray-200/60 dark:border-surface-border/40">
        <h3 class="text-sm font-semibold text-gray-900 dark:text-content-primary mb-3">{{ t('build.ciConfig') }}</h3>
        ...
        <div class="bg-white dark:bg-surface-card rounded border border-gray-200/60 dark:border-surface-border/40 p-4 mb-4">
          ...
          <div class="mb-4">
            ...
            <input
              ...
              type="text"
              class="w-full max-w-xs px-3 py-2 bg-white dark:bg-surface-layer border border-gray-300 dark:border-surface-border rounded text-sm text-gray-900 dark:text-content-primary focus:ring-1 focus:ring-primary-500 outline-none"
          ...
          <div class="flex gap-2">
            <button
              class="px-3 py-2 text-sm font-medium btn-primary transition-colors disabled:opacity-50"
        ...
        <div v-if="generatedConfig" class="bg-white dark:bg-surface-card rounded border border-gray-200/60 dark:border-surface-border/40 p-4">
          ...
          <textarea
            ...
            class="w-full bg-gray-50 dark:bg-surface-layer rounded p-3 text-xs text-gray-800 dark:text-content-secondary font-mono resize-y min-h-[200px] max-h-96 focus:ring-1 focus:ring-primary-500 outline-none"
            spellcheck="false"
          ></textarea>
        </div>
      </div>
