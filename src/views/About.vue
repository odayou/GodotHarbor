...
<template>
  ...
  <div v-else class="space-y-3">
    <div class="flex gap-2 border-b border-gray-200/60 dark:border-surface-border/40">
      <button
        @click="activeTab = 'about'"
        :class="[activeTab === 'about' ? 'tab-item-active' : 'tab-item']"
      >
        {{ t('about.tabs.about') }}
      </button>
      <button
        @click="activeTab = 'credits'"
        :class="[activeTab === 'credits' ? 'tab-item-active' : 'tab-item']"
      >
        {{ t('about.tabs.credits') }}
      </button>
      <button
        @click="activeTab = 'sponsor'"
        :class="[activeTab === 'sponsor' ? 'tab-item-active' : 'tab-item']"
      >
    ...
    <div v-if="activeTab === 'about'" class="space-y-3">
        ...
        <div class="flex items-center justify-center gap-2 mt-2">
          ...
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="butt" stroke-linejoin="miter" stroke-width="1.5" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
            </svg>
          </button>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div class="card p-4 text-center">
          <div class="w-8 h-8 mx-auto mb-2 bg-blue-100 dark:bg-surface-hover rounded flex items-center justify-center">
            <svg class="w-5 h-5 text-blue-600 dark:text-brand-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="card p-4 text-center">
          <div class="w-8 h-8 mx-auto mb-2 bg-green-100 dark:bg-green-900/30 rounded flex items-center justify-center">
        ...
        <div class="card p-4 text-center">
          <div class="w-8 h-8 mx-auto mb-2 bg-purple-100 dark:bg-surface-hover rounded flex items-center justify-center">
            <svg class="w-5 h-5 text-purple-600 dark:text-content-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="butt" stroke-linejoin="miter" stroke-width="1.5" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
          </div>
      ...
      <div class="card p-4">
        <h3 class="text-sm font-semibold text-gray-900 dark:text-content-primary mb-3">{{ t('about.techStack') }}</h3>
    ...
    <div v-if="activeTab === 'credits'" class="space-y-3">
      <div class="card p-4">
        <h2 class="text-sm font-semibold text-gray-900 dark:text-content-primary mb-2">{{ t('about.creditsTitle') }}</h2>
        <p class="text-sm text-gray-600 dark:text-content-muted mb-6">
          {{ t('about.creditsDesc') }}
        </p>

        <h3 class="text-sm font-semibold text-gray-900 dark:text-content-primary mb-3">{{ t('about.rustDeps') }}</h3>
        ...
        <h3 class="text-sm font-semibold text-gray-900 dark:text-content-primary mb-3">{{ t('about.jsDeps') }}</h3>
        <div class="space-y-2 mb-6">
          <div
            v-for="dep in jsDeps"
            :key="dep.name"
        ...
        <h3 class="text-sm font-semibold text-gray-900 dark:text-content-primary mb-3">{{ t('about.inspiration') }}</h3>
        <div class="space-y-2">
          <div
    ...
    <div v-if="activeTab === 'sponsor'" class="space-y-3">
      <div class="card p-8 text-center">
        ...
        <h2 class="text-sm font-semibold text-gray-900 dark:text-content-primary mb-2">{{ t('about.sponsorTitle') }}</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        <!-- <div class="card p-6">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-10 h-10 bg-yellow-100 dark:bg-yellow-900/30 rounded flex items-center justify-center">
          ...
          <a href="https://buymeacoffee.com" target="_blank" class="inline-block px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 text-sm">
            {{ t('about.buyCoffee') }}
          </a>
        </div>
        ...
        <div class="card p-6">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-10 h-10 bg-gray-900 dark:bg-gray-100 rounded flex items-center justify-center">
          ...
          <a href="https://github.com/sponsors" target="_blank" class="inline-block px-4 py-2 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 rounded hover:bg-gray-800 dark:hover:bg-surface-hover text-sm">
        ...
        <div class="card p-4">
          <div class="flex items-center gap-3 mb-3">
            ...
            <h3 class="text-sm font-semibold text-gray-900 dark:text-content-primary">{{ t('about.starGithub') }}</h3>
          </div>
        ...
        <div class="card p-4">
          <div class="flex items-center gap-3 mb-3">
            ...
            <h3 class="text-sm font-semibold text-gray-900 dark:text-content-primary">{{ t('about.contributeAction') }}</h3>
          </div>
          <p class="text-sm text-gray-600 dark:text-content-muted mb-3">
