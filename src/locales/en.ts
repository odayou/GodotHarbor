...
export default {
  ...
  mcp: {
    ...
    subtitle: 'Configure MCP Server to let AI Agents manage Godot project environments',
    ...
    claudeDesktop: 'Claude Desktop Integration',
    claudeDesktopDesc: 'Add the following config to claude_desktop_config.json',
    cursor: 'Cursor Integration',
    cursorDesc: 'Add the following config to .cursor/mcp.json',
    copyConfig: 'Copy Config',
    configCopied: 'Config copied',
    resourcesList: 'Projects, Project Environment, Expected Environment, Drift Report, Available Plugins, Installed Engines, Templates',
    toolsList: 'check_drift, sync_environment, install_plugin, switch_engine, create_from_template, build_project, check_updates',
    promptsList: 'diagnose_environment, suggest_plugins, setup_ci_cd'
  }
}