...
export default {
  ...
  projects: {
    ...
    hasDrift: '漂移',
    recheck: '重新检测',
    environmentInSync: '环境一致，无漂移',
    syncEnvironment: '一键同步环境',
    syncPreviewTitle: '同步预览',
    noActionsNeeded: '无需操作，环境已一致',
    actionInstall: '安装',
    actionUpdate: '更新',
    actionRemove: '移除',
    confirmSync: '确认同步',
    ...
    skippedCount: '跳过',
    failedCount: '失败',
    syncPartialWarning: '同步完成，部分项失败',
    syncEnvironmentSuccess: '环境同步完成',
    noDriftData: '未检测',
    sortByName: '按名称',
    sortByPath: '按路径',
    sortByVersion: '按版本',
    ...
    addProjectDialog: {
      ...
      noDesc: '无描述',
      fillRequired: '请填写必填项',
      templateCreated: '项目 {name} 创建成功',
      templateFailed: '从模板创建失败: {error}',
    ...
    specifyEngineFirst: '请先为项目指定引擎',
    installingModule: '正在安装 {type} 模块...',
    groupCreated: '分组「{name}」已创建',
    deleteGroupConfirm: '确定要删除分组「{name}」吗？该分组下的项目将变为未分组。',
    ...
    tabEnvironment: '环境',
    tabVcs: '版本控制',
    lockfileSection: '环境锁定 (harbor.lock)',
    snapshotSection: '环境备份',
    deleteGroup: '删除分组',
    createGroup: '创建新分组',
    groupName: '分组名称',
    groupNamePlaceholder: '例如：2D项目、3D项目',
    groupIcon: '图标 (Emoji)',
    groupColor: '颜色',
    groupDescription: '描述 (可选)',
    groupDescriptionPlaceholder: '分组描述',
    preview: '预览'
  },
  lockfile: {
    generate: '生成锁文件',
    verify: '检查一致性',
    sync: '同步',
    noLockDesc: '项目尚未生成 harbor.lock 锁文件。点击"生成锁文件"记录当前环境状态，便于团队协作和版本控制。',
    pluginsLocked: '{count} 个插件已锁定',
    lockedAt: '锁定时间:',
    engine: '引擎:',
    versionMismatch: '版本 {expected} → {actual}',
    envDiff: '环境差异',
    refresh: '刷新',
    checkDiff: '检查差异',
    strictSync: '严格同步',
  ...
  vcs: {
    ...
    noRemote: '无远程',
    switchBranch: '切换分支',
    checkoutConfirm: '确定要切换到分支「{branch}」吗？如有未提交的更改可能会丢失或产生冲突。',
    newBranchName: '新分支名称',
    createBranch: '创建',
    staged: '已暂存',
    noChanges: '无变更',
    ...
    checkoutSuccess: '已切换到分支: {branch}',
    checkoutFailed: '切换分支失败',
    createBranchSuccess: '已创建分支: {branch}',
    createBranchFailed: '创建分支失败',
    branchNameRequired: '请输入分支名称',
    gitignoreUpdated: '.gitignore 已更新',
    gitignoreUpdateFailed: '更新 .gitignore 失败',
    statusClean: '干净',
    statusModified: '已修改',
    statusUntracked: '未跟踪',
    statusAhead: '领先',
    statusBehind: '落后',
    statusDiverged: '分叉',
    diffSummary: '{added} 新增 / {modified} 修改 / {deleted} 删除',
    notGitProject: '此项目未使用 Git 版本控制',
    nonGit: '非Git'
  },
  plugins: {
    title: '插件生态',
  ...
  assetLibrary: {
    ...
    importToVault: '导入到仓库',
    oneClickInstallToProject: '一键安装到项目',
    selectProject: '选择项目',
  ...
  engines: {
    ...
    relocate: '重新定位',
    relocateTitle: '选择引擎新路径',
    relocateSuccess: '引擎路径已更新',
  ...
  settings: {
    ...
    densityDefault: '标准',
    densityCompact: '紧凑',
    densityDesc: '紧凑模式减小间距和侧边栏宽度，适合小屏幕',
    save: '保存设置',
    data: '数据',
    dataManagement: '数据管理',
    dataOps: '数据操作',
  ...
  home: {
    ...
    recentProjects: '最近项目',
    engines: '引擎',
    driftAlert: '{count} 个项目存在环境漂移',
    driftAlertDesc: '点击查看详情并一键同步环境',
    step1: '1. 扫描项目',
  ...
  build: {
    ...
    delete: '删除',
    deleteTemplate: '删除模板',
    deleteTemplateConfirm: '确定要删除此导出模板吗？',
    installed: '已安装',
    notInstalled: '未安装',
    version: '版本',
    mono: 'Mono',
    presets: '导出预设',
    presetsDesc: '管理项目的导出预设配置',
    builtinPresets: '内置预设',
    applyPreset: '应用预设',
    savePreset: '保存预设',
    presetName: '预设名称',
    presetPlatform: '目标平台',
    presetApplied: '导出预设已应用',
    presetSaved: '导出预设已保存到 .harbor.yml',
    buildProject: '构建项目',
    buildDesc: '选择项目和平台进行构建',
    selectProject: '选择项目',
    selectPlatform: '选择平台',
    startBuild: '开始构建',
    building: '构建中...',
    ...
    clearAll: '全部清除',
    allRecordsCleared: '构建记录已全部清除',
    downloadAll: '下载全部',
    deleteAll: '删除全部',
    allDownloaded: '全部下载完成',
    allDeleted: '全部删除完成',
    partialFailed: '{failed}/{total} 项操作失败',
    clearAllConfirm: '确定要清除所有构建记录吗？此操作不可撤销。',
    deleteAllConfirm: '确定要删除所有已安装的导出模板吗？此操作不可撤销。',
    duration: '耗时',
    seconds: '秒',
    output: '输出路径',
    ciConfig: 'CI/CD 配置',
    ciDesc: '生成 CI/CD 配置文件',
    provider: 'CI 提供商',
    githubActions: 'GitHub Actions',
    gitlabCi: 'GitLab CI',
    generate: '生成配置',
    writeConfig: '写入项目',
    configGenerated: '配置已生成',
    configWritten: '配置文件已写入项目',
  ...
  batchOps: {
    ...
    affectedProjects: '受影响的项目',
    globalUpgradeWarning: '此操作将升级所有使用此插件的项目到最新版本',
    upgradeResult: '升级结果',
    success: '成功',
    failed: '失败',
    confirmUpgrade: '确认升级',
    noProjectsUsingPlugin: '无项目使用此插件',
    snapshots: '环境快照',
    createSnapshot: '创建快照',
    noSnapshots: '暂无快照，点击上方按钮创建',
    viewDetail: '查看详情',
    restore: '恢复',
    noPluginsInSnapshot: '快照中无插件',
    deleteSnapshot: '删除快照',
    deleteSnapshotConfirm: '确定要删除此快照吗？此操作不可恢复。',
    restoreSnapshot: '恢复快照',
    restoreSnapshotConfirm: '恢复快照将覆盖当前环境配置，确定要继续吗？',
    pluginCount: '个插件'
  },
  mcp: {
    title: 'AI 协作 (MCP Server)',
    subtitle: '配置 MCP Server，让 AI 编程工具操作 Godot 项目环境',
    startServer: '启动（仅供测试）',
    serverRunning: 'MCP Server 运行中',
    serverStopped: 'MCP Server 未运行',
    stopServer: '停止服务',
    standaloneHint: 'MCP Server 通过 stdio 协议通信，需要由 AI 编程工具（如 Claude Desktop、Cursor）独立启动。上方的启动/停止按钮仅供内部测试使用。',
    exePath: '可执行文件路径',
    copyPath: '复制',
    pathCopied: '路径已复制',
    copyStartCommand: '复制终端启动命令',
    startCmdCopied: '启动命令已复制',
    resources: '资源',
    tools: '工具',
    prompts: '提示',
    capabilities: '可用能力',
    ...
    claudeDesktopDesc: '将配置添加到 Claude Desktop 的 MCP 配置文件中',
    cursor: 'Cursor',
    cursorDesc: '将配置添加到 Cursor 的 MCP 配置文件中',
    vscodeDesc: '将配置添加到 VS Code 的 MCP 配置中',
    traeDesc: '将配置添加到 Trae 的 MCP 配置中',
    copyConfig: '复制配置',
    configCopied: '配置已复制',
    usageGuide: '使用指南',
    step1: '点击上方"复制配置"按钮，复制 JSON 配置',
