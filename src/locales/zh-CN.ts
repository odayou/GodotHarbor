...
export default {
  ...
  mcp: {
    ...
    subtitle: '配置 MCP Server，让 AI Agent 操作 Godot 项目环境',
    startServer: '启动 MCP Server',
    serverRunning: 'MCP Server 运行中',
    serverStopped: 'MCP Server 未运行',
    resources: '可用资源',
    tools: '可用工具',
    prompts: '可用提示',
    claudeDesktop: 'Claude Desktop 集成',
    claudeDesktopDesc: '将以下配置添加到 claude_desktop_config.json',
    cursor: 'Cursor 集成',
    cursorDesc: '将以下配置添加到 .cursor/mcp.json',
    copyConfig: '复制配置',
    configCopied: '配置已复制',
    resourcesList: '项目列表、项目环境、期望环境、漂移报告、可用插件、已安装引擎、模板列表',
